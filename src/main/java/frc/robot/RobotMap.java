...
public class RobotMap {
  ...
  //List of all PWM ports
    ...
    //[M1]otor
    public static final int M1_Motor = PWM_0;
	
	//[M2]otor
	public static final int M2_Motor = PWM_1;
	public static final int M2_EncoderA = DIO_0;
	public static final int M2_EncoderB = DIO_1;

	//[M3]otor
	public static final int M3_Motor = PWM_2;
	public static final int M3_EncoderA = DIO_2;
	public static final int M3_EncoderB = DIO_3;
}